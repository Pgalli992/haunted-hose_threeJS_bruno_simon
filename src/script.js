...
// Door Light
const doorLight = new THREE.PointLight("#ffc078", 5);
...
const ghost4 = new THREE.PointLight("#69db7c", 2, 3);
...
ghost1.shadow.camera.top = 8;
ghost1.shadow.camera.far = 10;

ghost2.shadow.mapSize.set(256, 256);
ghost2.shadow.camera.top = 8;
ghost2.shadow.camera.far = 10;

ghost3.shadow.mapSize.set(256, 256);
ghost3.shadow.camera.top = 8;
ghost3.shadow.camera.far = 10;

ghost4.shadow.mapSize.set(256, 256);
ghost4.shadow.camera.top = 8;
...
const tick = () => {
  ...
  ghost4.position.x = Math.cos(ghost4Angle) * 4.5;
  ghost4.position.z = Math.sin(ghost4Angle) * 4.5;
  ghost4.position.y =
